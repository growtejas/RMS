...
function InterviewerCandidateProfileInner() {
  ...
  if (!Number.isFinite(id)) {
    return <div className="p-8 text-center text-sm text-red-700">Invalid candidate id.</div>;
  }
...
export default function InterviewerCandidateProfilePage() {
  return (
    ...
    >
      <InterviewerCandidateProfileInner />
    </Suspense>
  );
}
